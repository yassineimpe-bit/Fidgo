...
create table if not exists subscriptions (
  ...
  plan text not null default 'PILOT' check (plan in ('PILOT','FLEX','RETIKO_12','ANNUAL','STANDARD_MONTHLY','STANDARD_ANNUAL')),
  ...
  stripe_checkout_plan text check (stripe_checkout_plan is null or stripe_checkout_plan in ('FLEX','RETIKO_12','ANNUAL','STANDARD_MONTHLY','STANDARD_ANNUAL')),
