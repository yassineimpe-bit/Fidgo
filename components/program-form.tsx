...
export function ProgramForm({ program }: { program: Program }) {
  ...
  return <form className="form" onSubmit={submit}>
    ...
    {msg && <div className={`notice ${msg.includes("enregistré")?"success":"error"}`}>{msg}</div>}<button className="btn btn-primary" disabled={loading}>{loading?"Enregistrement…":"Enregistrer"}</button>
  </form>;
}
