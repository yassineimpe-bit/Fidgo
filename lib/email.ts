...
function emailVerificationDocument(restaurantName: string, verificationUrl: string) {
  const safeRestaurant = escapeHtml(restaurantName);
  ...
  <body lang="fr" dir="ltr" style="margin:0;background:#f6f7f9;color:#172033;font-family:Arial,sans-serif;">
    ...
    <main style="max-width:600px;margin:0 auto;padding:32px 20px;">
      <div style="background:#ffffff;border-radius:16px;padding:32px 24px;">
        ...
        <p style="margin:0 0 24px;line-height:1.6;">Une inscription Retiko a été initiée pour <strong>${safeRestaurant}</strong>. Confirmez votre adresse e-mail pour activer la connexion.</p>
        <p style="margin:0 0 24px;">
...
export async function sendEmailVerificationEmail(
  ...
  const payload = {
    ...
    text: [
      ...
      "",
      `Une inscription Retiko a été initiée pour ${restaurantName}. Confirmez votre adresse e-mail pour activer la connexion.`,
      "",
    ...
    html: emailVerificationDocument(restaurantName, input.verificationUrl),
  };
