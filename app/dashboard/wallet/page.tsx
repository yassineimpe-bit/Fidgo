...
export default async function WalletDashboardPage() {
  ...
  return <><AppNav restaurantName={restaurant?.name}/><main className="shell page">
    ...
    <section className="card" style={{marginTop:18}}><h3>Chemin vers le premier pass réel</h3><ol style={{lineHeight:1.8,paddingLeft:22}}><li>Base PostgreSQL, AUTH_SECRET et HTTPS opérationnels.</li><li>Créer une carte client depuis le QR d’inscription.</li><li>Configurer Google Wallet ou Apple Wallet dans les variables d’environnement.</li><li>Ouvrir la carte client et toucher le bouton Wallet correspondant.</li><li>Créditer la carte au scanner et vérifier que le solde du Wallet se met à jour.</li></ol></section>
